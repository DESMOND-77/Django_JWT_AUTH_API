...
class UserRegistrationView(BaseAPIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            # user = AuthenticationService.register(**request.data)
        ...
        #     return Response(
        #         standardized_response(success=False, message=str(e)),
        #         status=status.HTTP_400_BAD_REQUEST,
        #     )
...
class UserLoginView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            print(success,response_data,status_code,sep="\n")
            # create response based on service layer result
            response = Response(
...
class LogOutView(BaseAPIView):
    ...
    def post(self, request):
        try:
            ...
            # create response object
            response = (
                Response(standardized_response(**response_data), status=status_code),
            )

            # clear the refresh token cookie if it was used
            if settings.LWT_COOKIE_SECURE:
